...
[![My Skills](https://skillicons.dev/icons?i=bash,c,cpp,css,git,github,html,js,linux,md,mysql,neovim,py,raspberrypi,selenium,svg,vim,vscode,wordpress)](https://skillicons.dev)
